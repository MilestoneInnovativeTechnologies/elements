            ...
            <div class="content-wrapper">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-0 mb-2">Approve Order</h4>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-md-10">
                                            <a href="{{route('approval', ['id' => $data[0]->id])}}"  class="btn btn-primary">APPROVE</a>
                                            <a href="{{url('adminindex')}}"  class="btn btn-outline-secondary">Cancel</a>
                                        </div>
                                    </div>
                                </div>
