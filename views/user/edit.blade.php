        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-0 mb-4">User Account</h4>
                                        ...
                                        <div class="row">
                                            <div class="mb-3 col-md-6">
                                                ...
                                                <select name="role" class="select2 form-select">
                                                    <option value="executive" {{ $user->role == 'executive' ? 'selected' : '' }}>Sales Executive</option>
                                            ...
                                            <div class="mb-3 col-md-6">
                                                ...
                                                <input class="form-control" type="hidden" name="oldpassword" id="oldpassword" value="{{ $user->password }}">
